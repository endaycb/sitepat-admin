...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/bootstrap-responsive.min.css">
	<!-- jQuery UI -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/jquery-ui/smoothness/jquery-ui.css">
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/jquery-ui/smoothness/jquery.ui.theme.css">
	<!-- PageGuide -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/pageguide/pageguide.css">
	<!-- Fullcalendar -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/fullcalendar/fullcalendar.css">
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/fullcalendar/fullcalendar.print.css" media="print">
	<!-- chosen -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/chosen/chosen.css">
	<!-- select2 -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/select2/select2.css">
	<!-- icheck -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/icheck/all.css">
	
	<!-- Theme CSS -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/style.css">
	<!-- Color CSS -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/themes.css">
        <!-- Custom CSS -->
        <link rel="stylesheet" href="<?php echo base_url()?>dist/css/custom.css">
       <!-- Plupload -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/plupload/jquery.plupload.queue.css">
	<!-- Datepicker -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/datepicker/datepicker.css">
        	<!-- Tagsinput -->
	<link rel="stylesheet" href="<?php echo base_url()?>dist/css/plugins/tagsinput/jquery.tagsinput.css">
	<!-- Favicon -->
	<link rel="shortcut icon" href="<?php echo base_url()?>dist/img/favicon.ico" />
	<!-- Apple devices Homescreen icon -->
	<link rel="apple-touch-icon-precomposed" href="<?php echo base_url()?>dist/img/apple-touch-icon-precomposed.png" />
        <!--    JAVASCRIPT    -->
        <?php $this->load->view("element/javascript");?>
</head>
...
<body>
			...
			<div class="row-fluid">
				...
				<div class="span10">
					<dl class="dl-horizontal" style="margin-top:0;">
						...
						<dt>Social:</dt>
						<dd>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-facebook"></i></a>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-twitter"></i></a>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-linkedin"></i></a>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-envelope"></i></a>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-rss"></i></a>
							<a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-github"></i></a>
						</dd>
					</dl>
				</div>
			</div>
	...
	<?php $this->load->view("element/menu",$menus_back);?>