...
if(isset($item)){
    foreach($item as $row){
       ...
       if($type == "oli"){
            $info_item_value     = explode("-", $sae);
            
            $sae1   = $info_item_value[0];
                    ...
                    <div class="box box-bordered">
                        ...
                        <div class="box-content nopadding">
                            <form action="<?php echo base_url()?>index.php/<?php echo $this->uri->segment(1)?>/update" method="POST" class='form-horizontal form-striped' enctype="multipart/form-data">
                                        ...
                                        <div class="controls">
                                                <div class="input-xlarge">
                                                    <select name="position" id="position" class='chosen-select'>
                                                            ...
                                                            <option value="1" <?php if($position == 1) echo "selected"?>>Depan</option>
                                                            <option value="2" <?php if($position == 2) echo "selected"?>>Belakang</option>
                                        ...
                                        <div class="controls">
                                                <div class="input-xlarge">
                                                    <select name="size_type" id="size_type" class='chosen-select'>
                                                            ...
                                                            <option value="1" <?php if($size_type == 1) echo "selected"?>>Standar</option>
                                                            <option value="2" <?php if($size_type == 2) echo "selected"?>>Besar</option>
                                                            <option value="3" <?php if($size_type == 3) echo "selected"?>>Kecil</option>
                                                            <option value="5" <?php if($size_type == 5) echo "selected"?>>Ceper</option>
                                                        <
                                                    </select>
                                                </div>
                                        </div>
                                ...
                                <?php } ?>
                                 <?php if($form_sae == true){?>
                                <div class="control-group">
                                    <label class="control-label">SAE</label>
                                    <div class="controls">
                                        <input required type="text" name="sae1" id="textfield" placeholder="" value="<?php echo (int)$sae1?>" class="input-small"/> W - 
                                        <input required type="text" name="sae2" id="textfield" placeholder="" value="<?php echo $sae2?>" class="input-small"/>
                                    </div>
                                </div>
                                <?php } ?>
                                
                                <?php if($form_liter == true){?>
                                <div class="control-group">
                                    <label class="control-label">Liter</label>
                                    <div class="controls">
                                        <input required type="text" name="liter" value="<?php echo $liter?>" id="textfield" placeholder="" class="input-small"/>
                                    </div>
                                </div>
                                <?php } ?>
                                
                                <?php if($form_aki_type == true){?>
                                 <div class="control-group">
                                        <label  class="control-label">Size Type</label>
                                        <div class="controls">
                                                <div class="input-xlarge">
                                                    <select name="aki_type" id="aki_type" class='chosen-select'>
                                                        
                                                            <option value="1" <?php if($aki_type == 1) echo "selected"?>>Basah</option>
                                                            <option value="2" <?php if($aki_type == 2) echo "selected"?>>Kering</option>
                                                            <option value="3" <?php if($aki_type == 3) echo "selected"?>>Hybrid</option>
