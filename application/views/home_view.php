...
<!--					<div class="pull-right">
						<ul class="minitiles">
							<li class='grey'>
								<a href="<?php echo base_url()?>dist/#"><i class="icon-cogs"></i></a>
							</li>
							<li class='lightgrey'>
								<a href="<?php echo base_url()?>dist/#"><i class="icon-globe"></i></a>
							</li>
						</ul>
						<ul class="stats">
							<li class='satgreen'>
				...
				<div class="breadcrumbs">
					<ul>
						<li>
							<a href="<?php echo base_url()?>dist/more-login.html">Home</a>
							<i class="icon-angle-right"></i>
						</li>
						<li>
							<a href="<?php echo base_url()?>dist/index.html">Dashboard</a>
						</li>
					</ul>
					<div class="close-bread">
						<a href="<?php echo base_url()?>dist/#"><i class="icon-remove"></i></a>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span6">
						<div class="box box-color box-bordered">
							<div class="box-title">
								...
								<div class="actions">
									<a href="<?php echo base_url()?>dist/#" class="btn btn-mini content-refresh"><i class="icon-refresh"></i></a>
									<a href="<?php echo base_url()?>dist/#" class="btn btn-mini content-remove"><i class="icon-remove"></i></a>
									<a href="<?php echo base_url()?>dist/#" class="btn btn-mini content-slideUp"><i class="icon-angle-down"></i></a>
								</div>
							</div>
					...
					<div class="span12">
						<div class="box box-color box-bordered lightgrey">
							<div class="box-title">
								...
								<div class="actions">
									<a href="<?php echo base_url()?>dist/#new-task" data-toggle="modal" class='btn'><i class="icon-plus-sign"></i> Add Task</a>
								</div>
							</div>
								...
								<ul class="tasklist">
									<li class='bookmarked'>
										...
										<span class="task-actions">
											<a href="<?php echo base_url()?>dist/#" class='task-delete' rel="tooltip" title="Delete that task"><i class="icon-remove"></i></a>
											<a href="<?php echo base_url()?>dist/#" class='task-bookmark' rel="tooltip" title="Mark as important"><i class="icon-bookmark-empty"></i></a>
										</span>
									</li>
									<li>
										<div class="check">
						...
						<div class="box">
							...
							<div class="box-content nopadding scrollable" data-height="350" data-visible="true" data-start="bottom">
								<ul class="messages">
									...
									<li class="typing">
										<span class="name">John Doe</span> is typing <img src="<?php echo base_url()?>dist/img/loading.gif" alt="">
									</li>
									<li class="insert">
							...
							<div class="box-content nopadding scrollable" data-height="300" data-visible="true">
								<table class="table table-user table-nohead">
									<tbody>
										...
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-1.jpg" alt=""></td>
											<td class='user'>Bi Doe</td>
											<td class='icon'><a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-search"></i></a></td>
										</tr>
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-2.jpg" alt=""></td>
										...
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-3.jpg" alt=""></td>
											<td class='user'>Dan Doe</td>
											<td class='icon'><a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-search"></i></a></td>
										</tr>
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-4.jpg" alt=""></td>
										...
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-5.jpg" alt=""></td>
											<td class='user'>John Doe</td>
											<td class='icon'><a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-search"></i></a></td>
										</tr>
										<tr>
											<td class='img'><img src="<?php echo base_url()?>dist/img/demo/user-6.jpg" alt=""></td>
											<td class='user'>John Doe</td>
											<td class='icon'><a href="<?php echo base_url()?>dist/#" class='btn'><i class="icon-search"></i></a></td>
										</tr>
										<tr class="alpha">
					...
					<div class="span6">
						<div class="box box-color box-bordered green">
							<div class="box-title">
								...
								<div class="actions">
									<a href="<?php echo base_url()?>dist/#" class="btn btn-mini custom-checkbox checkbox-active">Automatic refresh<i class="icon-check-empty"></i></a>
								</div>
							</div>
							<div class="box-content nopadding scrollable" data-height="400" data-visible="true">
								<table class="table table-nohead" id="randomFeed">
									<tbody>
										<tr>
											<td><span class="label"><i class="icon-plus"></i></span> <a href="<?php echo base_url()?>dist/#">John Doe</a> added a new photo</td>
										</tr>
										<tr>
										...
										<tr>
											<td><span class="label label-warning"><i class="icon-comment"></i></span> <a href="<?php echo base_url()?>dist/#">John Doe</a> commented on <a href="<?php echo base_url()?>dist/#">News #123</a></td>
										</tr>
										<tr>
											<td><span class="label label-success"><i class="icon-user"></i></span> New user registered</td>
										</tr>
