                        ...
                        <div class="box-content nopadding">
                            <form action="<?php echo base_url() ?>index.php/<?php echo $this->uri->segment(1) ?>/create" method="POST" class='form-horizontal form-striped' enctype="multipart/form-data">
                                <div class="control-group">
                                    <label for="image_" class="control-label">Promo Image<small>1355px * 311px</small></label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                ...
                                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                <div>
                                                    <span class="btn btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input required type="file" name='image_thumb' id="image_thumb"/></span>
                                                    <a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php }
                                ...
                                <div class="control-group">
                                    ...
                                    <div class=" nopadding controls">
                                        <textarea name="ck" class=' span12'  id="editor1" rows="5"></textarea>
                                    </div>		
                                </div>
