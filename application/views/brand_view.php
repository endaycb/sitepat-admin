...
foreach($fields as $row_fields){
                                                                                  ...
                                                                                  ?>
                                                                                    <td><?php 
                                                                                            if($row_fields!="image"){ //mencari apakah field berupa field image.
                                                                                                if($row_fields=="brand_for"){
                                                                                                    echo str_ireplace(array("1","2","3","4"), array("BAN","OLI","AKI","VEHICLE"), $row->{$row_fields});
