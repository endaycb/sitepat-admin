    ...
    <div id="main">
		...
		<div class="span12">
                    <div class="box box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-th-list"></i> Edit <?php echo $title?> Article</h3>
                        </div>
                        <div class="box-content nopadding">
                            ...
                            <div class="control-group">
                                        <label for="image_" class="control-label">Article Image</label>
                                        <div class="controls">
                                ...
                                <div class="control-group">
                                        <label for="desc" class="control-label">Article</label>
                                ...
                                <div class="control-group">
                                        <label for="label" class="control-label">Article Tags</label>
                                        <div class="controls">
                                                <div class="span12">
