                                                  ...
                                                  ?>
                                                      <td>
                                                        ...
                                                        <?php
                                                            ...
                                                            else if($row_fields == "desc" || $row_fields == "article" || $row_fields == "address"){ echo htmlentities(substr($row->{$row_fields}, 0, 40))."...";  }
                                                            else{ echo $row->{$row_fields};
                                                        ?>
                                                    </td>
                                                    <?php } }?>
                                                    <td>
                                                        <a href="<?php if($row->status!=1)echo base_url()."index.php/".$this->uri->segment(1)."/change_status/".$row->id; else echo "#"?>" class="btn btn-small btn-<?php echo $button?>" <?php echo $disable?>><i class="icon-<?php echo $icon?>"></i></a>
