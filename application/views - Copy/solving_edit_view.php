    ...
    <div id="main">
		...
		<div class="span12">
                    <div class="box box-bordered">
                        <div class="box-title">
                            <h3><i class="icon-th-list"></i> Edit <?php echo $title?> Solving</h3>
                        </div>
                        <div class="box-content nopadding">
                            ...
                            <div class="control-group">
                                        <label for="image_" class="control-label">Solving Image</label>
                                        <div class="controls">
                                ...
                                <div class="control-group">
                                        <label for="desc" class="control-label">Solving Article</label>
                                        <div class="box-content nopadding controls">
                                            <textarea name="ck" class='ckeditor span12' id="article" rows="5"><?php echo $article?></textarea>
                                        </div>		
                                </div>
                                <div class="control-group">
                                        <label for="label" class="control-label">Solving Tags</label>
                                        <div class="controls">
                                                <div class="span12">
